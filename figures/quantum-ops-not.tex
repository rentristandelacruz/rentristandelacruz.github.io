...
% Point ket-psi
\filldraw[red] ( 1.00, 1.732) circle (0.02cm);
\node [fill=white,text=red] (ket3) at ( 1.48, 1.976) {$\ket{\psi}$  $(\alpha,\beta)$};
\draw [->,thick,red] (0,0) -- (0.99, 1.72);
...
% Point ket-psi-prime
\filldraw[red] (-1.732, 1.00) circle (0.02cm);
\node [fill=white,text=red] (ket5) at (-2.45, 1.10) {$\ket{\psi'}$  $(-\alpha,\beta)$};
\draw [->,thick,red] (0,0) -- (-1.72, 0.99);

% Point not-ket-psi-prime
\filldraw[blue] (1.00, -1.732) circle (0.02cm);
\node [fill=white,text=blue] (ket6) at (1.80,-1.95) {$X(\ket{\psi'})$  $(\beta,-\alpha)$};
