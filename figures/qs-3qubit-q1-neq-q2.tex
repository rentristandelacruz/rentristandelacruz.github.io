...
\draw [->] (node0xx) -- (node01x) node[midway, above right ] {$1$};                                                           
\draw [->] (node1xx) -- (node10x) node[midway, above left  ] {$1$};                                                           
